...
import 'package:referredline/core/widgets/secret_code_field.dart';
...
void main() {
  ...
  testWidgets('the secret field asks the keyboard not to learn or suggest '
      'what is typed', (tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: SecretCodeField(
