...
class _ProtectedScreenState extends State<_ProtectedScreen> {
  ...
  Widget build(BuildContext context) => Scaffold(
    body: widget.showCode ? const _SecretPanel() : const Text('entering a key'),
  );
}

/// An inner widget that protects itself while it shows a secret, as a
/// one-time key display does.
class _SecretPanel extends StatefulWidget {
  const _SecretPanel();

  @override
  State<_SecretPanel> createState() => _SecretPanelState();
}

class _SecretPanelState extends State<_SecretPanel> {
  @override
  void initState() {
    super.initState();
    SecureScreen.acquire();
  ...
  @override
  Widget build(BuildContext context) => const Text('synthetic secret');
}
...
void main() {
  ...
  testWidgets('closing a secret shown inside a protected screen does '
