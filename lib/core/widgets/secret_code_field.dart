...
/// Entry for a recovery secret (the Backup Recovery Key). Keeps what is typed away from the keyboard and the clipboard:
///
...
/// on a real phone (to be checked when a restore screen exists).
